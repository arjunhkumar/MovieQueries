...
# export JAVA_HOME=/home/arjun/Working_Directory/Softwares/Utilities/jdk/
export JAVA_HOME=/home/arjun/Working_Directory/Softwares/Utilities/jdk/
# export JAVA_HOME=/home/arjun/Working_Directory/Softwares/Utilities/OpenJDK/openjdk-14/jdk-14/
...
SPARK_OPTS="$SPARK_OPTS --conf spark.executorEnv.JAVA_HOME=$JAVA_HOME"
...
function run {
	...
	# JVM_OPTS="$JVM_OPTS -Xjit:verbose"
	JVM_OPTS="$JVM_OPTS -XX:ValueTypeFlatteningThreshold=99999"
	# JVM_OPTS="$JVM_OPTS -XX:-EnableArrayFlattening"
	JVM_OPTS="$JVM_OPTS -Xverify:none"
